<nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarsDefault">
        ...
        <ul class="navbar-nav ml-auto align-items-center">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('users.index',['username'=>Auth::user()->username])}}"><img class="rounded-circle mr-2" src="{{url('storage/'.Auth::user()->image_url)}}" width="30"><span class="align-middle">{{Auth::user()->username}}</span></a>
            </li>
